...
public class ProductController {
   ...
   @RequestMapping(value = "/product/getByFlavour/{productFlavour}", method = RequestMethod.GET)
	public @ResponseBody Collection<Product> byFlavour( @PathVariable("productFlavour") String productFlavour) {
		Collection<Product> product = productservice.getByFlavour(productFlavour);
		return product;
	}
   @RequestMapping(value = "/product/getByCategoryId/{productCategoryId}", method = RequestMethod.GET)
   ...
   public @ResponseBody Category createCatagory(@RequestBody Category productCatagory) {
	   ...
	   Category created = productservice.saveProductCatagory(productCatagory);
	   return created;
    }
   ...
   public @ResponseBody Brand createBrand(@RequestBody Brand productBrand) {
	   ...
	   Brand created = productservice.saveProductBrand(productBrand);
	   return created;
    }
   ...
   @RequestMapping(value = "/product/getByBrand/{productBrand}", method = RequestMethod.GET)
